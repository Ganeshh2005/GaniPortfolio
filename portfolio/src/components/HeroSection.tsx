...
export default function HeroSection() {
    ...
    useEffect(() => {
        ...
        // 4.5 New: Precise Blend Animation for Section 3 End
        gsap.to("#blend-overlay", {
            opacity: 1,
            ease: "none",
            scrollTrigger: {
                trigger: "#section-3",
                start: "70% top", // Start fading in near the end of the last sequence
                end: "bottom top",
                scrub: true,
            }
        });
    ...
    return (
        <div ref={containerRef} className="hero-container">
            <div className="canvas-container">
                ...
                {/* Full-width blend overlay — perfectly synchronized via GSAP */}
                <div 
                    id="blend-overlay"
                    style={{
                        position: 'absolute',
                        inset: 0,
                        background: 'linear-gradient(to bottom, transparent 30%, rgba(240,180,120,0.6) 70%, #f0c898 100%)',
                        opacity: 0,
                        zIndex: 1,
                        pointerEvents: 'none'
                    }} 
